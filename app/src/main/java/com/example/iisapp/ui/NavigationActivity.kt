...
class NavigationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home,  R .id.nav_notification, R.id.nav_solicitudes, R.id.nav_tramites_personales, R.id.nav_tramites_institucionales   //R.id.nav_gallery, R.id.nav_slideshow,
            ), drawerLayout
        )
